...
**Office Hours**: Wednesday 4:00--6:00, I will be in a BB Collaborate session.  Feel free to log in and ask questions.

**Email**:  matthew.brigida@sunyit.edu

**Class Location**: Online (Synchronous)

**Class Day/Time**: Synchronous Online Wednesday 6:00pm to 9:30pm.  We will meet via Blackboard Collaborate. All lectures will also be recorded.
...
| Exam 2                           |     25 |
| Final Exam                       |     30 |
| Attendance/Project/Participation |     20 |
|----------------------------------+--------|
| Total Points                     |    100 |
|----------------------------------+--------|
