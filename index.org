...
**Office Hours**: Monday and Wednesday 12--2pm, and on-request I will create a BB Collaborate session where you can log in and ask questions.
...
There will be three exams.  The exams will be multiple choice. Failure to complete an exam by the due date will result in a grade of 0.
...
There are 4 assignments under Content > Assignments in BackBoard.
...
We will cover chapters 1 through 14.  Since this course is asynchronous, you have a measure of flexibility regarding when you cover each chapter.  The due dates for the exams/assignments are below:
